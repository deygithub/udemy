...
/*
Challenge vectors
write a c++ program a follows:

Declare 2 empty vectors of integers named vector1 and vector2 respectively

Add 10 and 20 to vector1 dynamically using push_back
Display the elements in vector1 using the at() method as well as its sixe using the size() method
...
Display the elements in vector101
*/
...
int main(){
    ...
    cout << "vector2 contans " << vector2.size() <<" elements" << endl;
